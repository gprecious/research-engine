'use client';
/* Landing page — verbatim port of claude.ai/design v5 handoff landing.jsx.
   Visual structure preserved; only hash-router calls swapped for Next.js <Link>. */
...
const landingStyles: Record<string, CSSProperties> = {
  page: {
    minHeight: '100vh',
    background: '#ffffff',
    color: VECTRA_INK,
