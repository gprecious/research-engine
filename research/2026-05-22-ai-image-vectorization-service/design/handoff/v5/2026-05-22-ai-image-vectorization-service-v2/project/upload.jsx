/* Upload page — file picker, Convert action, svg-preview region with mock SVG result. */
...
const uploadStyles = {
  ...
  sub: { fontSize: 16, color: VECTRA_MUTED, margin: 0, maxWidth: 640 },
  grid: {
    display: "grid",
...
function Upload() {
  ...
  const [opts, setOpts] = React.useState({ mode: "color", colors: "6", output: "SVG" });
