...
<link href="https://fonts.googleapis.com/css2?family=Archivo+Black:wght@900&family=Archivo:wght@400;700&display=swap" rel="stylesheet">
...
section.title h1 { font-size: 104pt; line-height: 0.92; }
section h1 { font-size: 48pt; }
section h2 { font-size: 36pt; }
section strong { color: var(--a1); font-weight: 900; }
section a { color: var(--a2); text-decoration: none; border-bottom: 3px solid var(--a2); }
section.lead { display: flex; flex-direction: column; justify-content: center; }
section.lead h1 { font-size: 88pt; line-height: 0.95; }
section.divider { background: var(--a1); color: var(--bg); display: flex; flex-direction: column; justify-content: center; }
section.divider h1 { font-size: 112pt; color: var(--bg); line-height: 0.9; }
section.divider p { font-family: var(--heading-font); font-size: 28pt; color: var(--bg); opacity: 0.7; margin-top: 16px; letter-spacing: 0.04em; text-transform: uppercase; }
...
단일 Marp 템플릿 + QuickChart GET URL — 모든 주제가 같은 레이아웃을 받는다.
...
Design Quality·Originality에 가중치, Craft·Functionality는 베이스라인. 생성자와 평가자는 반드시 분리.
...
예제·QA·디스커버리·백엔드·평가 — 각 레포가 하나씩 다른 축을 해결한다.
